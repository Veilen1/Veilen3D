  ...
  return (
    <section className="w-full relative overflow-hidden pb-12">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-background to-primary/10 -z-10">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-secondary/20 rounded-full blur-3xl -z-10 animate-pulse delay-700" />
      </div>

      <div className="container mx-auto px-4 pt-12 md:pt-20 lg:pt-28 relative z-10 mb-12">
        <div className="flex flex-col items-center text-center gap-6 max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight text-balance bg-clip-text text-transparent bg-gradient-to-r from-foreground to-primary/60">
          ...
          <a href="#productos" className="mt-4">
            <button className="bg-primary text-primary-foreground px-8 py-3 rounded-full font-medium hover:bg-primary/90 transition-all hover:scale-105 shadow-lg hover:shadow-primary/25 cursor-pointer">
              Ver Productos
            </button>
          </a>
        </div>
